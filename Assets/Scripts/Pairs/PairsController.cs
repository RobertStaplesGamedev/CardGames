...
public class PairsController : MonoBehaviour {
    ...
    [SerializeField] private PairsMainCard originalCard;
    ...
    private void Start()
    {
        ...
        for(int i = 0; i < gridCols; i++)
        {
            for(int j = 0; j < gridRows; j++)
            {
                ...
                {
                    card = Instantiate(originalCard) as PairsMainCard;
                }
    ...
    private PairsMainCard _firstRevealed;
    private PairsMainCard _secondRevealed;
    ...
    public void CardRevealed(PairsMainCard card)
    {
